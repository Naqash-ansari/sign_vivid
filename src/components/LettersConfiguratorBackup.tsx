...
(function () {
  ...
  function sendDesign(button) {
    ...
    if (!canvas) {
      window.open("https://wa.me/447728339751?text=" + encodeURIComponent(message), "_blank", "noopener,noreferrer");
      return;
    }
    ...
    canvas.toBlob(function (blob) {
      ...
      if (navigator.canShare && navigator.canShare({ files: [file] }) && navigator.share) {
        navigator.share({
          ...
          downloadDesign();
          window.open("https://wa.me/447728339751?text=" + encodeURIComponent(message + " I have downloaded the design image and will attach it here."), "_blank", "noopener,noreferrer");
        }).finally(function () {
          if (button) {
            button.textContent = "Request design update";
            button.disabled = false;
      ...
      downloadDesign();
      window.open("https://wa.me/447728339751?text=" + encodeURIComponent(message + " The design image has downloaded on my device; I will attach it in this chat."), "_blank", "noopener,noreferrer");
      if (button) {
        button.textContent = "Request design update";
        button.disabled = false;
      }
